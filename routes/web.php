...
Route::middleware(['auth:sanctum', 'verified'])->prefix('information')->group(function () {
    Route::get('all', [InformationController::class, 'AllInformation'])->name('all.information');
    Route::get('addInformation', [InformationController::class, 'AddInformation'])->name('add.information');
    Route::post('storeInformation', [InformationController::class, 'StoreInformation'])->name('store.information');
...
// Services All Routes
Route::middleware(['auth:sanctum', 'verified'])->prefix('service')->group(function () {
...
// Project All Routes
Route::middleware(['auth:sanctum', 'verified'])->prefix('project')->group(function () {
...
// Courses All Routes
Route::middleware(['auth:sanctum', 'verified'])->prefix('course')->group(function () {
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('review')->group(function () {
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('footer')->group(function () {
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('chart')->group(function () {
