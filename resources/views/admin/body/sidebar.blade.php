<div class="deznav">
    <div class="deznav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{ route('add.chart.content') }}">Add Chart Content</a></li>
        ...
        <div class="copyright">
            <p><strong>Laravel Admin Dashboard</strong> © 2021 All Rights Reserved</p>
            <p class="fs-12">Made with <span class="heart"></span> by Lalit Aryan</p>
        </div>
    </div>
</div>
