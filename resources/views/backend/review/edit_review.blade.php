                            ...
                            <div class="basic-form">
                                ...
                                <form method="post" action="{{ route('review.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="client_description" class="form-control" rows="4"
                                            id="comment">{{ $review->client_description }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <img id="showImage" src="{{ asset($review->client_img) }}"
