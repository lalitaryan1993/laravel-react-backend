                                ...
                                <form method="post" action="{{ route('project.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="project_description" class="form-control" rows="4"
                                            id="comment">{{ $project->project_description }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="project_features" class="form-control" rows="4" id="comment">{{ $project->project_features }}
                                                    </textarea>
                                    ...
                                    <div class="form-group">
                                        <img id="showImage" src="{{ asset($project->img_one) }}"
                                    ...
                                    <div class="form-group">
                                        <img id="showImage2" src="{{ asset($project->img_two) }}"
                                            style="width: 100px; height: 100px;">
                                    </div>
